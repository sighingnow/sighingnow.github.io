...
StackOverflow上有一个问题是一个很好的处理"shift/reduce conflicts"的例子：[Shift/reduce conflicts in bison][2]
...
[2]: http://stackoverflow.com/questions/17590190/shift-reduce-conflicts-in-bison
