\documentclass[$if(fontsize)$$fontsize$,$endif$$if(lang)$$lang$,$endif$$if(papersize)$$papersize$,$endif$$for(classoption)$$classoption$$sep$,$endfor$]{article}%%{$documentclass$}
...
\defaultfontfeatures{Mapping=tex-text,Scale=MatchLowercase}
% \setmainfont{Times New Roman} %% {Consolas} {Monaco} {Courier New}
\punctstyle{quanjiao}
...
% \author{@sighingnow \href{mailto:sighingnow@gmail.com}{sighingnow@gmail.com}}
$endif$
